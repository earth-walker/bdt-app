...
public class FieldNames {
    ...
    public static final String PUBLISHED_FORM_PATH = "published_form_path";
    ...
    public static final String DMN_NAME = "name";
    public static final String PUBLISHED_DMN_PATH = "published_dmn_path";
